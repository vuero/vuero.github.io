...
import { d as defineComponent, r as ref, ab as onMounted, au as onBeforeUnmount, o as openBlock, b as createElementBlock, e as createBaseVNode, G as Fragment, J as renderList, n as normalizeClass } from "./vendor.9ec557a4.js";
  ...
  constructor(e) {
    _defineProperty$1(this, "get", (e2) => {
      ...
      if (!is.object(e2))
        return;
      let t = this.get();
      is.empty(t) && (t = {}), extend(t, e2), window.localStorage.setItem(this.key, JSON.stringify(t));
...
function loadSprite(e, t) {
  ...
  if (!i || !n()) {
    ...
    fetch(e).then((e2) => {
      is.empty(e2) || (n2 && window.localStorage.setItem(`cache-${t}`, JSON.stringify({ content: e2 })), r(a, e2));
    }).catch(() => {
    });
  }
}
    ...
    _defineProperty$1(this, "firstTouch", () => {
      ...
      this.bind(t.inputs.seek, i, (t2) => {
        ...
        this.bind(i2, "mouseenter mouseleave", (i3) => {
          t.controls.hover = !e2.touch && i3.type === "mouseenter";
        });
...
const vimeo = { setup() {
  ...
  const r = buildUrlParams(__spreadValues({ loop: e.config.loop.active, autoplay: e.autoplay, muted: e.muted, gesture: "media", playsinline: !this.config.fullscreen.iosNative }, n));
  ...
  if (l.setAttribute("src", c), l.setAttribute("allowfullscreen", ""), l.setAttribute("allow", ["autoplay", "fullscreen", "picture-in-picture", "encrypted-media", "accelerometer", "gyroscope"].join("; ")), is.empty(s) || l.setAttribute("referrerPolicy", s), i || !t.customControls)
    l.setAttribute("data-poster", e.poster), e.media = replaceElement(l, e.media);
  else {
    const t2 = createElement("div", { class: e.config.classNames.embedContainer, "data-poster": e.poster });
    t2.appendChild(l), e.media = replaceElement(t2, e.media);
  }
  t.customControls || fetch(format(e.config.urls.vimeo.api, c)).then((t2) => {
    !is.empty(t2) && t2.thumbnail_url && ui.setPoster.call(e, t2.thumbnail_url).catch(() => {
    });
  }), e.embed = new window.Vimeo.Player(l, { autopause: e.config.autopause, muted: e.muted }), e.media.paused = true, e.media.currentTime = 0, e.supported.ui && e.embed.disableTextTrack(), e.media.play = () => (assurePlaybackState$1.call(e, true), e.embed.play()), e.media.pause = () => (assurePlaybackState$1.call(e, false), e.embed.pause()), e.media.stop = () => {
    e.pause(), e.currentTime = 0;
  };
  let { currentTime: u } = e.media;
  Object.defineProperty(e.media, "currentTime", { get: () => u, set(t2) {
  ...
  Object.defineProperty(e.media, "playbackRate", { get: () => d, set(t2) {
    e.embed.setPlaybackRate(t2).then(() => {
      d = t2, triggerEvent.call(e, e.media, "ratechange");
    }).catch(() => {
      e.options.speed = [1];
    });
  } });
  let { volume: h } = e.config;
  Object.defineProperty(e.media, "volume", { get: () => h, set(t2) {
    e.embed.setVolume(t2).then(() => {
      h = t2, triggerEvent.call(e, e.media, "volumechange");
    });
  } });
  let { muted: m } = e.config;
  Object.defineProperty(e.media, "muted", { get: () => m, set(t2) {
    const i2 = !!is.boolean(t2) && t2;
    e.embed.setVolume(i2 ? 0 : e.config.volume).then(() => {
      m = i2, triggerEvent.call(e, e.media, "volumechange");
    });
  } });
  let p, { loop: g } = e.config;
  Object.defineProperty(e.media, "loop", { get: () => g, set(t2) {
    const i2 = is.boolean(t2) ? t2 : e.config.loop.active;
    e.embed.setLoop(i2).then(() => {
      g = i2;
    });
  } }), e.embed.getVideoUrl().then((t2) => {
    p = t2, controls.setDownloadUrl.call(e);
  }).catch((e2) => {
    this.debug.warn(e2);
  }), Object.defineProperty(e.media, "currentSrc", { get: () => p }), Object.defineProperty(e.media, "ended", { get: () => e.currentTime === e.duration }), Promise.all([e.embed.getVideoWidth(), e.embed.getVideoHeight()]).then((t2) => {
    const [i2, s2] = t2;
    ...
    u = t2, triggerEvent.call(e, e.media, "timeupdate");
    ...
    e.media.seeking = false, u = t2.seconds, triggerEvent.call(e, e.media, "timeupdate");
...
class Plyr {
  ...
  set currentTrack(e) {
    captions.set.call(this, e, false);
  }
  get currentTrack() {
...
const _hoisted_2 = ["data-poster"];
const _hoisted_3 = ["src"];
const _hoisted_4 = ["default", "srclang", "src"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        __props.embed ? (openBlock(), createElementBlock("iframe", {
          ...
          allowtransparency: "",
          allow: "autoplay"
        }, null, 8, _hoisted_1)) : (openBlock(), createElementBlock("video", {
          key: 1,
          ref: (_value, _refs) => {
